...
$Referer_check_domain = "https://test.hiroaki-s-portfolio.com/";
...
$subject = "Marketing and One お問い合わせ";
...
$require = array('name', 'email', 'tel', 'message', 'checkbox');
...
$refrom_name = "Marketing and One";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問い合わせいただき誠にありがとうございます";
...
お問い合わせありがとうございました。
お問い合わせ内容確認の上、３営業日以内にご連絡させていただきます。
